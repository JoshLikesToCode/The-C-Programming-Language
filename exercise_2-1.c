/* write a program to determine the ranges of char, shrot, int, and long variables,
*  both signed and unsigned, by printing appropriate values from standard headers and by
*  direct computation. Hard if you compute them: determine the ranges of various floating-
*  point types. */
